...
@RestController
@RequestMapping("/v3/datasources")
public class EOSCDatasourceController {
    private static final Logger logger = LoggerFactory.getLogger(EOSCDatasourceController.class);

    private final ServiceBundleService serviceBundleService;

    public EOSCDatasourceController(ServiceBundleService serviceBundleService) {
