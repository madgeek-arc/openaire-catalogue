...
@Component
public class EOSCProviderCatalogueFactory {

    private static final Logger logger = LoggerFactory.getLogger(EOSCProviderCatalogueFactory.class);
    private final ProviderRepository providerRepository;
    private final ProviderService providerService;
    private final JmsTemplate jmsTopicTemplate;
    private final ProviderMailService registrationMailService;

    public EOSCProviderCatalogueFactory(ProviderRepository providerRepository,
